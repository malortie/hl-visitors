...
void EV_Pipe(event_args_t *args)
{
	...
	if (EV_IsLocal(idx))
	{
		...
		{
		case 0:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(PIPE_ATTACK1MISS, 1); break;
		case 1:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(PIPE_ATTACK2MISS, 1); break;
		case 2:
			gEngfuncs.pEventAPI->EV_WeaponAnimation(PIPE_ATTACK3MISS, 1); break;
		}
	}
}
//======================
